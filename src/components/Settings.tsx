...
const EditIcon = getIDByName('ic_edit_24px')
const UserIcon = getIDByName('ic_group_dm')
        ...
        <ScrollView>
            <View style={styles.container}>
                ...
                <View style={styles.title}>
                    <Text style={styles.name}>ShowUserName</Text>
                    <Text style={styles.author}>by mafu</Text>
                </View>
            </View>
            <FormSection title="SETTING">
                <FormRow
                    label="Replace server nickname entirely"
                    leading={<FormRow.Icon source={EditIcon}/>}
                    trailing={
                        <FormSwitch
                            value={settings.getBoolean("replace",false)}
                            onValueChange={(value) => {
                                settings.set("replace", value)
                            }}
                        />
                    }
                />
                <FormRow
                    ...
                    leading={<FormRow.Icon source={UserIcon}/>}
                    trailing={
                        <FormSwitch
                            value={settings.getBoolean("display",true)}
                            onValueChange={(value) => {
                                settings.set("display", value)
                            }}
                        />
                    }
                />
            ...
            <FormSection title="INFORMATION">
                ...
                <FormRow
                    ...
                    onPress={() => {
                        Linking.openURL("https://github.com/m4fn3/ShowUserName")
                    }}
                />
            </FormSection>
